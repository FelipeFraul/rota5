-- Materialized HIGH #1 CONTRACT migration.
-- Source: supabase/rollout/gate_credential_session_revocation_contract.sql.
-- Rollout gates A-I passed before materialization.
