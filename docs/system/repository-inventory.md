...
## Baseline 2.9.0 functional delta

The functional boundary is `b2ddf8a57aa329fd25c277a91f8c4326f4b98b1c..c7ed2c31eb9c322ef489e71bb59631c39928a1e0`. It adds `src/lib/tickets/services/comboOperationalDelivery.ts`, `scripts/test-combo-operational-delivery.mjs` and `supabase/migrations/20260915000600_make_combo_operational_notifications_durable.sql`; it changes combo redemption, worker, outbound delivery, kitchen scanner and focused tests. Documentary paths between older SHAs are excluded from the functional delta and source fingerprint. Current source count: 397; test inventory: 60.


## Baseline 2.8.1 source inventory

The functional inventory remains at 394 files; the dependency graph has 818 edges (616 direct, 138 indirect, 64 external).

## Baseline 2.8.0 source inventory

Canonical functional source `c48405e41df3d1cd69eb3d383b7c6dd17257155e`: 394 source files after canonical exclusions, fingerprint `ef5d175d8edf5c867131ac4e65f80555e0e5839640595b486ee79c9b99885f91`, 88 migrations, 45 tables, 63 SQL functions, 1 sequence and 59 catalogued test artifacts.

## Baseline 2.7.0 source inventory

Canonical algorithm derives 391 functional source files and fingerprint `9a9ab1a24c824a879213174a34ba1940eded2eeaf90fca26494a6eb24bc9dbee` from `1f504eb4e4a08ab8f8de3ff3a39e1803f625dc27`; the repository contains 88 migrations, 45 catalogued tables, 63 SQL functions, 1 sequence and 57 test files. The functional diff from `0a10618648fc3f873afffd8f60e60bd0396b62e7` contains one functional commit after excluding the 2.6.x documentary commits.
