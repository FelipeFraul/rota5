...
## Baseline 2.7.1 state reconciliation

The 74 primary lifecycle transitions are unchanged. Internal combo metadata transitions now use PostgreSQL row locks and current-state JSONB merge; versioned READY no longer bypasses the queued scan contract.
