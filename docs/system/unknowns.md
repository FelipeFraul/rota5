...
| U-012 | ÓRFÃO / POSSÍVEL LEGADO | Assets sem consumidor e assets RockBar ausentes | cinco imagens sem referência textual; `BrandLogo.tsx` não tem importador; CSS pede `/rockbar.webp` e `/rockbar_mb.webp`, inexistentes | uso por URL/dados externos e impacto dos seletores CSS ativos |
