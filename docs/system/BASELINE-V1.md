...
**Identity:** `rota5-baseline-v1`, version **2.4.3**, status **FROZEN**. Its canonical functional source is pure commit `67845326088eac47452224b00ef1e866036e86f1`, with 368 files and fingerprint `df6e8976738d2c05dd13d4ea988af12c05531e533f9b8b0feb456084ad82d6c0`. The baseline commit is `SELF_NOT_RECORDED` to avoid self-reference.
