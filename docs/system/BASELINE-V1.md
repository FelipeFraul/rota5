...
The logical rate-limit module now lists its actual runtime exports; the proxy reuses its pure contract through a direct CALLS dependency while keeping a REST adapter. The graph has 255 nodes and 818 edges. The canonical functional source and Production deployment remain those of Baseline 2.8.0.
