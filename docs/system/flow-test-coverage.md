...
| `kitchen.combo_redemption` | PARTIAL | `test-036`<br>`audit.combo-redemption-security` | NENHUMA | Cinco casos comportamentais locais passam; falta validação mutante remota. |
