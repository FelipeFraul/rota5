...
Current Production deployment `dpl_4ZaUUZxWjjjL51jKejGfXA8Ho27g` is READY on exact canonical functional source `1f504eb4e4a08ab8f8de3ff3a39e1803f625dc27`, proven by Vercel REST v13 `meta.githubCommitSha`; earlier deployments remain historical evidence.
...
| --- | --- | --- | --- | --- | --- |
| `drift.vercel-project-domain` | MATCH / RESOLVED | CRITICAL (histórico) | canonical functional source `1f504eb4e4a08ab8f8de3ff3a39e1803f625dc27`; documentary HEAD não é runtime target | Vercel `rota5` ligado ao mesmo repo/branch | Identidade e source funcional Production reconciliados; auto-deploy Git permanece desabilitado. |
...
| Published commit | canonical functional source `1f504eb4e4a08ab8f8de3ff3a39e1803f625dc27` | Vercel REST v13 metadata `githubCommitSha=1f504eb4e4a08ab8f8de3ff3a39e1803f625dc27` | deployment Production READY `dpl_4ZaUUZxWjjjL51jKejGfXA8Ho27g`; health é suplementar | MATCH |
