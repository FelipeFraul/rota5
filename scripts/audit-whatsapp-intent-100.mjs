...
const cases = [
  ...
  ["help", "Não consigo comprar online", idle, true, "purchase_support"],
  ["help", "O pagamento não abre", idle, true, "purchase_support"],
  ["help", "Erro no pix", idle, true, "purchase_support"],
  ["help", "Problema com pagamento", idle, true, "purchase_support"],
